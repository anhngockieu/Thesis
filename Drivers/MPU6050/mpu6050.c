...
#define GYRO_500			0x01
#define GYRO_1000			0x02
#define GYRO_2000			0x03
#define PI                  3.14159265359
// Setup MPU6050
#define MPU6050_ADDR 0xD0
const uint16_t i2c_timeout = 100;
const double Accel_Z_corrector = 14418.0;    //14418 - - 1802.0
double Acc_scale = 16384.0; // 16384 - 2048
double Gyro_scale = 131.0;	// 131.0 16.4
