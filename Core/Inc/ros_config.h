...
#define READ_ENCODER							4		/*!< Time index read encoder */
...
#define CMD_VEL_PUBLISH_FREQUENCY              10       	/*!< Frequency in Hz to publish robot velocity */
#define DRIVE_INFORMATION_PUBLISH_FREQUENCY    10       	/*!< Frequency in Hz to publish drive information */
#define SAMPLE_TIME 						   100		/*!< Period in ms to read encoder */
